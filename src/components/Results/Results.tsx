...
const Results: React.FC = () => {
  const { driverStandings, constructorStandings, loading, error } = useStandings();
            ...
            <Table
              ...
              renderRow={(driver: DriverStanding) => (
                <tr key={driver.position} className="driver__info">
                  <td style={{ width: 62, height: 42, paddingLeft: '8px' }}>
                    {driver.position}
                  </td>
                  <td style={{ width: 98 }}>
                    <img
                  ...
                  <td style={{ width: 82, paddingLeft: '8px' }}>
                    {driver.points}
                  </td>
                </tr>
              )}
            ...
            <Table
              ...
              renderRow={(constructor: ConstructorStanding) => (
                <tr key={constructor.position} className="driver__info">
                  ...
                  <td style={{ width: 82, height: 42, paddingLeft: '8px' }}>
                    {constructor.points}
                  </td>
                </tr>
              )}
